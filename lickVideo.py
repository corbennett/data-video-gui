...
#        self.imageViewBox.addItem(self.imageItem)
        ...
        self.lickFrames = np.zeros(self.totalVidFrames)
        self.otherContactFrames = np.zeros(self.totalVidFrames)
